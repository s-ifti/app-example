 ...
 */
public class CloudwatchMetricSink extends RichSinkFunction<List<Tuple4<String,String,Timestamp, Double>>> implements CheckpointedFunction {
    ...
    private List<Tuple4<String , String, Timestamp, Double>> values;
    ...
    public CloudwatchMetricSink(String flinkEventCategory) {
        ...
        this.values = new ArrayList<Tuple4<String, String, Timestamp, Double>>();
    ...
    private void flushValuesBuffer()  {
        ...
        values.forEach(v-> {
            ...
            String metricName = v.f1;
            MetricDatum datum = new MetricDatum()
                    .withMetricName(metricName)
                    .withUnit(StandardUnit.None)
                    .withValue(v.f3)
                    .withTimestamp( java.util.Date.from( v.f2.toInstant() ))
    ...
    @Override
    public void invoke(List<Tuple4<String,String,Timestamp, Double>> document)  {
